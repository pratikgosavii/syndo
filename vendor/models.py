...
class ProductSettings(models.Model):
    ...
    # Product Fields
    wholesale_price = models.BooleanField(default=True)
    stock = models.BooleanField(default=True)
    imei = models.BooleanField(default=True)
    ...
    brand_name = models.BooleanField(default=True)
    color = models.BooleanField(default=True)
    size = models.BooleanField(default=True)
    batch_number = models.BooleanField(default=True)
    expiry_date = models.BooleanField(default=True)
    ...
    general_delivery = models.BooleanField(default=True)
    shop_orders = models.BooleanField(default=True)

    # Policies
    return_policy = models.BooleanField(default=True)
    cod = models.BooleanField(default=True)
    replacement = models.BooleanField(default=True)
    shop_exchange = models.BooleanField(default=True)
    shop_warranty = models.BooleanField(default=True)
    brand_warranty = models.BooleanField(default=True)

    # Catalog
    online_catalog_only = models.BooleanField(default=True)
...
class Offer(models.Model):
    ...
    product = models.ForeignKey("vendor.product", on_delete=models.SET_NULL, blank=True, null=True, related_name="offers")
