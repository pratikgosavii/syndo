...
# Load .env from project root so CASHFREE_* and other env vars are available (works regardless of cwd)
try:
...
HTML2PDF_API_KEY = '2rQZrGcx5RXuunGJudQt8V5CREtXNam2QsYwCGTR60iSdmdI4ELTVVItPSlIoLHy'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'vendor.context_processors.header_notifications',
            ],
        },
    },
]
